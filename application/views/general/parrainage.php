...
<!-- PARRAINAGE -->
<form id="frmParrain" method="POST">
     <div class="parrainage bottom-10">
          ...
          <div class="parrain-section <?php echo (isset($parainNumTel)&&isset($parainNumCont)&&!empty($parainNumTel)&&!empty($parainNumCont))?"open":"";?> column twelve top-20" style="display: none;">            
            ...
            <input type="text" maxlength="10" placeholder="Numéro de téléphone de votre parrain" class="validate[required,custom[integer],minSize[10]]" name="parrain_num_tel" value="<?php echo isset($parainNumTel)?$parainNumTel:"";?>" id="parrain_num_tel">

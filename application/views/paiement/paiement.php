...
<!--          <input type="hidden" name='titulaire' value="nom prenom" class="validate[required]" id="titulaire" maxsize = "60">-->
        ...
        <div class='column border-gray misc-custom-5 top-20 p20all'>
          ...
          <div class='column three top-10'>Titulaire</div><div class='column nine top-10'><input class='validate[required,custom[onlyLetterSp]]' type='text' name='titulaire_cb' id='titulaire_cb' maxlength="60"/></div>

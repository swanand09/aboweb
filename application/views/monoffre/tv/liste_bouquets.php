            ...
            <div class='columns four bouquet'>
              <ul id='filter'>
                  <?php 
                   ...
                   ?>
                            <li>
                                <a href="#" onclick='javascript: choixBouquet("<?php echo $key2; ?>_<?php echo $val2; ?>_<?php echo $bouquet_list[strtoupper($key2)]["nombreChaine"]; ?>_<?php echo $vodTarif; ?>_<?php echo $numriquEnreg; ?>");' data-group='<?php echo strtolower($key2); ?>'>
                                  <div class='columns five'>
                                    <span class='nombre_chaines'>+<?php echo $bouquet_list[strtoupper($key2)]["nombreChaine"]; ?></span>
                                    <label>Chaines</label>
                                  </div>

...
<form class='frm-options' action='#' onsubmit='javascript:retrieveForfait();return false'> 
  ...
  <label for="checkbox3"><?php echo form_checkbox($input1); ?> Je souhaite réduire ma facture en résiliant mon abonnement chez France Télécom/Orange car je suis en zone dégroupée. <span><a href='#' class='has-tip' data-width='360' title='En décochant cette option vous continuerez à payer votre abonnement téléphonique actuel auprès de votre fournisseur (généralement France Telecom) et bénéficierez d’une réduction de 5€ TTC/ mois sur l’ensemble des forfaits box mediaserv.'><?php echo image('info_icon.png',NULL,array("title"=>"Plus info", "alt"=>"Plus info","class"=>"border-gray")); ?></a></span></label>
  <?php }?>

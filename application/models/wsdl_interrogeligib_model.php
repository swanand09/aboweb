...
class Wsdl_interrogeligib_model extends CI_Model
{
   ...
   var $nusoap_client;
    ...
    public function __construct()
    {
        ...
        try
        {
            //$this->nusoap_client = new nusoap_client("http://192.168.64.46/WebserviceAboweb/Service.asmx?wsdl",true,false,false,false,false,300); //preprod dev
            $this->nusoap_client = new nusoap_client("http://192.168.64.58/WebserviceAboweb/Service.asmx?wsdl",true,false,false,false,false,300); //preprod testing
